    ...
    public static void main(String[] args) {
        {
            ...
            TriPredicate<String> allEqual = (fst, snd, trd) -> ((Objects.isNull(fst) && Objects.isNull(snd) && Objects.isNull(trd)) || (fst.equals(snd) && snd.equals(trd)));
        ...
        }
        {
            ...
            TriPredicate<Integer> straightUp = (fst, snd, trd) -> fst < snd && snd < trd;
        ...
        }
        {
            ...
            TriPredicate<Boolean> exactly1 = (fst, snd, trd) -> (fst && !snd && !trd) || (!fst && snd && !trd) || (!fst && !snd && trd);
        ...
        }
        {
            ...
            TriPredicate<String> lexical = (fst, snd, trd) -> fst.compareTo(snd) <= 0 && snd.compareTo(trd) <= 0;
